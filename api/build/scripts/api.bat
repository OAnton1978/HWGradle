...
set CLASSPATH=%APP_HOME%\lib\api-1.0-SNAPSHOT.jar;%APP_HOME%\lib\service-1.0-SNAPSHOT.jar;%APP_HOME%\lib\db-1.0-SNAPSHOT.jar

@rem Execute api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %API_OPTS%  -classpath "%CLASSPATH%" Anton.Main %CMD_LINE_ARGS%
