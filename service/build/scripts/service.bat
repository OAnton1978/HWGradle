...
set CLASSPATH=%APP_HOME%\lib\service-1.0-SNAPSHOT.jar;%APP_HOME%\lib\db-1.0-SNAPSHOT.jar

@rem Execute service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVICE_OPTS%  -classpath "%CLASSPATH%" Anton.Main %CMD_LINE_ARGS%
